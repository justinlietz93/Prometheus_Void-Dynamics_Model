...
- [derivation/code/computational_proofs/VDM_theory_and_results.md](code/computational_proofs/VDM_theory_and_results.md)
...
- [derivation/VDM_voxtrium_mapping.md](VDM_voxtrium_mapping.md)
...
- [derivation/code/computational_proofs/VDM_theory_and_results.md](code/computational_proofs/VDM_theory_and_results.md): Insert RD note; replace fixed m_eff numeric with param-dependent form.  
...
- [derivation/VDM_voxtrium_mapping.md](VDM_voxtrium_mapping.md): Make RD canonical; EFT references scoped.  
