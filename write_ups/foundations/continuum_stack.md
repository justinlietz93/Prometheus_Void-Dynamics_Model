...
- EFT/KG branch [PLAUSIBLE, quarantined]:
  ...
  - See [kinetic_term_derivation.md](Prometheus_VDM/write_ups/effective_field_theory/kinetic_term_derivation.md:1) and [effective_field_theory_approach.md](Prometheus_VDM/write_ups/effective_field_theory/effective_field_theory_approach.md:1).
...
- Noether-style invariants apply to the EFT action, not to the RD dissipative flow; see [symmetry_analysis.md](Prometheus_VDM/write_ups/foundations/symmetry_analysis.md:1) for context. [SCOPE]
...
- See logs referenced in [LOG_20250824.md](Prometheus_VDM/write_ups/DAILY_LOGS/LOG_20250824.md:1).
...
- See [discrete_to_continuum.md](Prometheus_VDM/write_ups/foundations/discrete_to_continuum.md:1) and status log [CORRECTIONS.md](Prometheus_VDM/write_ups/CORRECTIONS.md:1).

Results (pointers)

- Front-speed PASS and dispersion PASS recorded with figures/logs; see:
  - [rd_front_speed_experiment.py](Prometheus_VDM/write_ups/code/physics/reaction_diffusion/rd_front_speed_experiment.py:1)
  - [rd_dispersion_experiment.py](Prometheus_VDM/write_ups/code/physics/reaction_diffusion/rd_dispersion_experiment.py:1)
- Overview banner and dimensionless constants: [VDM_Overview.md](Prometheus_VDM/write_ups/VDM_Overview.md:1).
...
- Coupling of memory-steering overlays to the RD baseline; see [memory_steering.md](Prometheus_VDM/write_ups/memory_steering/memory_steering.md:1). [PLAUSIBLE]

Provenance

- Kinetic/action normalization: [kinetic_term_derivation.md](Prometheus_VDM/write_ups/effective_field_theory/kinetic_term_derivation.md:1).
- Discrete→continuum baseline: [discrete_to_continuum.md](Prometheus_VDM/write_ups/foundations/discrete_to_continuum.md:1).
- Status/edits: [CORRECTIONS.md](Prometheus_VDM/write_ups/CORRECTIONS.md:1).