...
- EFT/KG branch [PLAUSIBLE, quarantined]:
  ...
  - See [kinetic_term_derivation.md](Prometheus_FUVDM/write_ups/effective_field_theory/kinetic_term_derivation.md:1) and [effective_field_theory_approach.md](Prometheus_FUVDM/write_ups/effective_field_theory/effective_field_theory_approach.md:1).
...
- See validation script: [rd_dispersion_experiment.py](Prometheus_FUVDM/write_ups/code/physics/reaction_diffusion/rd_dispersion_experiment.py:1) and doc [rd_dispersion_validation.md](Prometheus_FUVDM/write_ups/reaction_diffusion/rd_dispersion_validation.md:1).

Front speed (Fisher–KPP)

- Theory: c_front = 2 √(D r). [PROVEN]
- Experiment: [rd_front_speed_experiment.py](Prometheus_FUVDM/write_ups/code/physics/reaction_diffusion/rd_front_speed_experiment.py:1) and doc [rd_front_speed_validation.md](Prometheus_FUVDM/write_ups/reaction_diffusion/rd_front_speed_validation.md:1).
...
- Noether-style invariants apply to the EFT action, not to the RD dissipative flow; see [symmetry_analysis.md](Prometheus_FUVDM/write_ups/foundations/symmetry_analysis.md:1) for context. [SCOPE]
...
- Outputs auto-routed to write_ups/code/outputs/{figures,logs}/reaction_diffusion with timestamped names.
- See logs referenced in [LOG_20250824.md](Prometheus_FUVDM/write_ups/DAILY_LOGS/LOG_20250824.md:1).
...
- See [discrete_to_continuum.md](Prometheus_FUVDM/write_ups/foundations/discrete_to_continuum.md:1) and status log [CORRECTIONS.md](Prometheus_FUVDM/write_ups/CORRECTIONS.md:1).

Results (pointers)

- Front-speed PASS and dispersion PASS recorded with figures/logs; see:
  - [rd_front_speed_experiment.py](Prometheus_FUVDM/write_ups/code/physics/reaction_diffusion/rd_front_speed_experiment.py:1)
  - [rd_dispersion_experiment.py](Prometheus_FUVDM/write_ups/code/physics/reaction_diffusion/rd_dispersion_experiment.py:1)
- Overview banner and dimensionless constants: [FUVDM_Overview.md](Prometheus_FUVDM/write_ups/FUVDM_Overview.md:1).
...
- Coupling of memory-steering overlays to the RD baseline; see [memory_steering.md](Prometheus_FUVDM/write_ups/memory_steering/memory_steering.md:1). [PLAUSIBLE]

Provenance

- Kinetic/action normalization: [kinetic_term_derivation.md](Prometheus_FUVDM/write_ups/effective_field_theory/kinetic_term_derivation.md:1).
- Discrete→continuum baseline: [discrete_to_continuum.md](Prometheus_FUVDM/write_ups/foundations/discrete_to_continuum.md:1).
- Status/edits: [CORRECTIONS.md](Prometheus_FUVDM/write_ups/CORRECTIONS.md:1).